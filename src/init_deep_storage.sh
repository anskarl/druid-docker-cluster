...
mc policy download deep_storage/${S3_STORAGE_BUCKET}
mc policy upload deep_storage/${S3_STORAGE_BUCKET}

mc mb deep_storage/${S3_LOGS_BUCKET}
mc policy download deep_storage/${S3_LOGS_BUCKET}
mc policy upload deep_storage/${S3_LOGS_BUCKET}